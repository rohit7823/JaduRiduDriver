...
class IncentiveRepositoryImpl implements IncentiveRepository{
  ...
  @override
  Future<Resource<UploadIncentiveResponse>> uploadIncentiveResponse(String userInputId) async{
    await Future.delayed(const Duration(seconds: 2));
    return Success(UploadIncentiveResponse(
        status: true, message: "Success", incentives: List.generate(5, (index) => Incentive(heading: "Congratulations!", description: "Lorem Ipsum is simply dummy text of the Task Completed..", incentivePrice: 100))));
  }
}