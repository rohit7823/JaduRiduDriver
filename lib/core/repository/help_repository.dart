...
abstract class HelpRepository {
  ...
  Future<Resource<UploadHelpInqueryResponse>> uploadInqueryData(String userId, String userInputName, String userInputEmail, String userInputSubject, String userInputMsg);
}