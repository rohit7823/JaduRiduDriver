...
import 'package:jadu_ride_driver/core/domain/user_personal_details.dart';
...
class RequiredDataWelcomeJaduRideResponse extends BusinessObject {
  ...
  factory RequiredDataWelcomeJaduRideResponse.fromJson(
      ...
      RequiredDataWelcomeJaduRideResponse(
          ...
          states: List<Package>.from(
              json["states"].map((x) => Package.fromJson(x))),
          personalDetails: UserPersonalDetails.fromJson(json["personalData"]));
  ...
  Map<String, dynamic> toJson() => {
        ...
        "personalData": personalDetails.toJson()
      };
}
