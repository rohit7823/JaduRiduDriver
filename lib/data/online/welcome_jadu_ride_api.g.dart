...
class _WelcomeJaduRideApi implements WelcomeJaduRideApi {
  _WelcomeJaduRideApi(this._dio, {this.baseUrl});
  ...
  @override
  Future<UserPrimaryRegistrationResponse> driverDetails(userId, userName,
      userEmail, refferalCode, stateID, districtId, cityId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UserPrimaryRegistrationResponse>(Options(
            ...
            .compose(_dio.options, '/driver/users/${userId}/details',
