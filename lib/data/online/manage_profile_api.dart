...
abstract class ManageProfileApi {
  ...
  Future<DistrictsResponse> districts(
      @Query("state_id") String stateId, @Query("userId") String userId);

  @GET("${ApiRoutes.parent}/cities")
  Future<CitiesResponse> cities(
      @Query("district_id") String districtId, @Query("userId") String userId);

  @GET("${ApiRoutes.parent}/users/{userId}/profile/details")
  Future<FetchProfileDetailsResponse> getProfile(@Path("userId") String userId);
