...
class IntroTwo extends StatelessWidget {
  IntroStore store;
  int pos;
  IntroTwo({Key? key, required this.store, required this.pos}) : super(key: key);
    ...
    return Align(
      ...
      child: FittedBox(
        child: Padding(
          ...
          child: SvgPicture.network("https://jaduridedev.v-xplore.com/${store.data[pos].coverImage}", width: 0.30.sh, height: 0.30.sh,),
        ),
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.only(bottom: 0.03.sw),
                child: Text(store.data[pos].body, style: AppTextStyle.introSubHeadingStyle, textAlign: TextAlign.center,maxLines: 3,))
          ],
        ),
      ),
    );
