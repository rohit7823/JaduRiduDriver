...
import '../custom_widgets/my_app_bar.dart';
      ...
      children: [
                            ...
                            child: fitBox(
                              child: Column(
                                children: [
                                  ...
                                  widget.currentBalanceKM
                                      .text(AppTextStyle.currentBalanceDetails),
                                  /*StringProvider.currentBalanceKM_TXT
                                  .text(AppTextStyle.currentBalanceDetailsKM),*/
                                ],
                              ),
                            ),
                          ),
        ...
        Padding(
          ...
          child: ElevatedButton(
            ...
            child: StringProvider.rechargeNow.text(
                AppTextStyle.partnerButtonTxt),
          ),
        ),
      ],
    );
            ...
            child: Row(
              children: [
                Expanded(
                  ...
                  *//*Text(StringProvider.currentBalanceDate,
                        style: TextStyle(
                ...
                Expanded(
                    flex: 1,
                    child: SvgPicture.asset(ImageAssets.dateDownArrow))
              ],
            ),
          ),
        ),*/
