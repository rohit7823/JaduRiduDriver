...
import 'package:jadu_ride_driver/presentation/stores/registration_certificate_screen_store.dart';
...
class _RegistrationCertificationScreenState
  ...
  late final RegistrationCertificateStore _store;
  late final List<ReactionDisposer> _disposers;
  late final DialogController _controller;

  @override
  void initState() {
    _store = RegistrationCertificateStore();
    _controller =
      ...
      reaction((p0) => _store.openImagePicker, (p0) {
        if (p0 is DialogState && p0 == DialogState.displaying) {
          ImageChooserDialog.showChooseDialog(context,
            ...
            _store.openImagePicker = DialogState.notDisplaying;
          });
        }
      }),
  ...
  Widget _upperSideContent() {
    return Container(
      ...
      child: Align(
        ...
        child: fitBox(
          child: StringProvider.registrationCertificate
          ...
          expand(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  UploadImageView(
                      onClick: _store.onOpenPickerClick,
                      title: StringProvider.uploadRegistrationCertificate)
                ],
              )),
          const Divider(
